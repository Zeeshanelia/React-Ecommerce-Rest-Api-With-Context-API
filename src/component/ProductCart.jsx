...
const ProductCart = ({ products }) => {
    ...
    return (
        <div className="relative flex flex-col p-3 rounded-2xl md:mx-1 cursor-pointer justify-start
            ...
            <button className="w-full px-2 py-1 rounded-xl font-semibold text-sm bg-white/40 border border-white/50 text-slate-700 hover:bg-rose-200 hover:shadow-md flex gap-2 items-center justify-center transition-all duration-200 hover:scale-105 backdrop-blur-sm mt-1">
