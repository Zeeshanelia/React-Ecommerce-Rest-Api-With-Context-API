    ...
    return (
        <>
            <div className='mt-10 max-w-[100rem]  mx-auto'>
                ...
                <h1 className="font-semibold text-xl">My Cart Items - {cartItem.length}</h1>
                            ...
                            {cartItem.map((item, index) => (
                                <div key={index}
                                    ...
                                    <div className="flex items-center gap-4">
                                        <button className="flex items-center gap-3 bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition-colors">
                                            <Minus size={16} onClick={() => { }} className="cursor-pointer" />
                                            <span className="font-bold">{item.quantity || 1}</span>
                                            <Plus size={16} onClick={() => { }} className="cursor-pointer" />
                                        </button>
                            ...
                            <div className="flex gap-6 p-6">
                                ...
                                <div className="border border-gray-300 p-5 rounded-xl w-1/2 space-y-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            type="text" placeholder="Zeeshan Elia" value={userCheckOut.fullName}
                                    ...
                                    <div className="flex justify-center">
                                        <button onClick={userCheckOut} className="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg transition-all duration-200">
                                            Detect Location
                                        </button>
                                    </div>
                                </div>
